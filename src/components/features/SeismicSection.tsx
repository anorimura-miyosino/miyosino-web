...
const seismicData = {
  title: '高い耐震性能と安全性',
  description:
    'かわつる三芳野団地は、新耐震基準に適合し、専門機関による耐震診断により高い耐震性能が確認されています。震度6強（IP0.6以上）の地震にも耐えうる構造となっており、安心して長く住み続けられる安全性の高い建物です。',
  performance: {
    level: '震度6強（IP0.6以上）',
    standard: '新耐震基準適合',
    description:
      '1981年（昭和56年）に制定された新耐震基準に適合しており、中規模の地震（震度5強程度）では軽微な損傷にとどまり、大規模の地震（震度6強～7）でも倒壊・崩壊しない設計となっています。',
  },
  certification: {
